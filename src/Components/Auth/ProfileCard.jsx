...
import { Avatar, Button, Card, CardActions, CardContent, Collapse, Divider, Stack, Typography } from '@mui/material'
...
export default function ProfileCard() {
  ...
  async function LoadUserProfile() {
    ...
    .then((response) => {setuserNow(response.data) })
      ...
      <Card sx={{ width: 329 }}>
        ...
        <CardContent>
          <Stack direction="column" alignItems="center" spacing={1}>
            <Avatar src="./images/web/avatar-example.png" sx={{ width: 110, height: 110 }} />
              ...
              { Riwayat_Data?.map((rd, index) => (
                <Box key={index} paddingBottom={1.5}>
                  <Stack direction="row" spacing={2} sx={{ paddingBottom: 1.5 }}>
                    ...
                    <Box>
                      <Typography fontSize={13} color="tint.grey.50">{rd.location} . {rd.datetime}</Typography>
