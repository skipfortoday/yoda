...
import { Avatar, Button, Stack, Tab, Tabs } from '@mui/material';
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Stack direction="column" justifyContent="flex-end" sx={{ height: 100 }}>
              ...
              <Box sx={{ border: 0, width: { xs: '70vw', md: 'auto' } }} color="primary">
                <Tabs value={0} variant="scrollable" sx={{ paddingBottom: 0, }} /*onChange={handleChange} aria-label="basic tabs example"*/ 
                  textColor="primary"
                  indicatorColor="primary"
                >
                  <Tab label="Menunggu konfirmasi"/>
                  <Tab label="Disetujui" />
                  <Tab label="Ditolak" />
                </Tabs>
              </Box>
