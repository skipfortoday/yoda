...
const TEXTS = {
  ...
  form3: {
    ...
    header2: 'Email Anda telah didaftarkan. Silahkan tunggu 1x24 Jam untuk bisa menggunakan akun Anda.',
    submitButton: 'Tutup'
  }
}
...
export default function RegisterPage() {
  ...
  const [InputPassword, setInputPassword] = useState({ value: '', error: false, disabled: false, })
  const [InputCPassword, setInputCPassword] = useState({ value: '', error: false, disabled: false, })
  const [FullName, setFullName] = useState({ value: '', error: false, disabled: false, })
  const [PhoneNumber, setPhoneNumber] = useState({ value: '', error: false, disabled: false, })
  ...
  if (upMd) {
    return (
      <RegisterWeb 
        ...
        InputCPassword={InputCPassword} setInputCPassword={setInputCPassword}
